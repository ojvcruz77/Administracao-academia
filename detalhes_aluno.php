    ...
    <?php if (isset($nome)): ?>
        <form action="atualizar_aluno.php" method="POST">
            ...
            <p>
                ...
                <input type="number" id="peso" name="peso" step="0.01" value="<?php echo $peso; ?>" required>
            </p>
            <p>
            ...
            <p>
                ...
                <input type="text" id="plano" name="plano" value="<?php echo $plano; ?>" required>
            </p>
            <p>
                <label for="plano">Treino:</label>
                <input type="textarea" id="plano" name="plano" value="<?php echo $treino; ?>" rows = 10  cols = 25 required>
            </p>
